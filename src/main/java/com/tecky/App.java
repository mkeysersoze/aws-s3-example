...
public class App {
    ...
    private static void cleanUp(S3Client s3Client, String bucketName, String keyName) {
        System.out.println("Cleaning up...");
        try {
            deleteBucketObject(s3Client, bucketName, keyName);
    ...
    private static void deleteBucketObject(S3Client s3Client, String bucketName, String keyName) {
